        ...
        <div>
            ...
            <div className="flex flex-col mt-8">
                <div className=" mb-7 w-full sm:w-1/2 xl:w-[180px]">
                    <Link to="/admin/category/add" className="flex items-center px-2 py-2 shadow-sm rounded-md bg-blue-500 hover:scale-105 hover:bg-blue-700 hover:scale-105 ease-in-out transition-all ">
                                ...
                                {props.cate.map((item, index) => {
                                    return <tr key={index}>
                                        ...
                                        <td
                                            ...
                                            <Link to={`/admin/category/${item._id}/edit`} className="text-xs rounded-full bg-blue-500 text-white px-3 pt-[7px]  hover:scale-125 hover:bg-blue-700  ease-in-out transition-all ml-6">Edit</Link>
                                        </td>
                                    </tr>
