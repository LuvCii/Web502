                ...
                <div>
                    ...
                    <ul className="space-y-8 tracking-wide mt-8 ">
                        {categories.map((item) => (
                            ...
                            <li>
                                <Link to={`category/${item._id}`} aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
